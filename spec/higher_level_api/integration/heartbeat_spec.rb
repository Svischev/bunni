...
describe "Client-defined heartbeat interval" do
  context "with value > 0" do
    let(:connection) do
      c = Bunni.new(username: "bunni_gem", password: "bunni_password", vhost: "bunni_testbed", heartbeat_interval: 4)
      c.start
      c
    end
...
describe "Server-defined heartbeat interval" do
  let(:connection) do
    c = Bunni.new(username: "bunni_gem", password: "bunni_password", vhost: "bunni_testbed", heartbeat_interval: :server)
    c.start
    c
  end
